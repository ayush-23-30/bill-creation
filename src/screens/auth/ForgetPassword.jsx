  ...
  function ForgetInputField() {
    return (
      <div className=" mt-6 w-[90%] sm:w-[90%] md:w-[80%]">
        <div className="">
        <p className="text-md mb-[1px] text-gray-500">
           Email Address
          </p> 
        <CustomInput
        ...
        <div className="mt-5">
        <CustomButton onClick={handleClick} loading={loading} disabled={false}>
          Reset Password
        </CustomButton>
        </div>
      </div>
    ...
    return (
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-start px-10 md:px-20 h-screen">
        ...
        <div className="mt-6 md:mt-12">
          ...
          <div className="mt-2">
          <p className="text-gray-500 leading-3.5 text-sm leading-">Enter the email associated with your account and we’ll send an email with instructions to reset your password.
</p>
          </div>
