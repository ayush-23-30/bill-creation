...
function Login() {
  ...
  function loginInputField() {
    return (
      <div className="border-2 h-52 mt-10 w-[90%] sm:w-[90%] md:w-[80%]"></div>
    );
  }
  ...
  function loginScreenData() {
    return (
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-start px-10 md:px-20 h-screen">
        <img src={logo} width={150} className="relative bottom-12 md:bottom-0" />
        <div className="mt-6 md:mt-12">
          <h2 className="text-3xl font-bold">Welcome back!</h2>
          <p className="text-gray-500 text-sm leading-2">Please Enter your Details.</p>
        </div>
        ...
        {/* Sign-Up Button */}
        <div className="border-[1px] cursor-pointer w-[90%] sm:w-[90%] md:w-[80%] border-[#D0D5DD] rounded-md shadow-md text-center hover:bg-gray-200 transition">
          <p className="flex justify-center font-semibold items-center p-2">
            Don't have an account?{" "}
            <a href="#" className="text-blue-500 pl-1 underline hover:text-blue-700">
              Sign-Up
            </a>
          </p>
        </div>
