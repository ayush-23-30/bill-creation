  ...
  return (
    <header className="flex justify-between items-center px-4 py-[6px] shadow-md rounded-b-xl bg-white relative">
      ...
      <div className=" md:flex items-center space-x-4">
        <button
          className="w-40 h-12 border-2 border-black text-md text-black px-6 py-2 rounded-full shadow-lg 
        ...
        <button className="w-40 h-12 bg-blue-600 text-md text-white px-6 py-2 rounded-full shadow-lg hover:bg-blue-700 cursor-pointer whitespace-nowrap hidden lg:inline-block">
          Get In Touch
        </button>
      </div>
    </header>
